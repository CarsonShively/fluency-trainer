...
def build_model():
    ...
    cross_attention_transformer = CrossAttentionTransformer(embeded_vector_size=128, dense=64, dense1=128, dropout=0.1)
    classifier_head = ClassifierHead(embeded_vector_size=128, dense=64, dense1=128, dropout=0.1)
    print("point 6")
